...
public class WildernessRoadCommandTests
{
    private readonly Mock<ISimulationViewModel> _mockViewModel;
    private readonly WildernessRoadCommand _command;
    private readonly RoleHunter _roleHunter;

    public WildernessRoadCommandTests()
    {
        // Initialize mocks
        _mockViewModel = new Mock<ISimulationViewModel>();

        // Create a real instance for RoleHunter
        ...
        _command = new WildernessRoadCommand(_mockViewModel.Object);
    }
